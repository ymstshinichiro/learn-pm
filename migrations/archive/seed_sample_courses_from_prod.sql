...
INSERT INTO courses (id, slug, title, category, description, is_public, created_at)
VALUES
  (1, 'pm-basic', 'プロジェクトマネジメント基礎', 'project-management', 'PMBOKに基づく基礎知識を学びます', 1, '2025-10-22 05:15:43.8724'),
  (2, 'pm-advanced', 'プロジェクトマネジメント応用', 'project-management', 'ステークホルダー管理とリスクマネジメントを学びます', 1, '2025-10-22 06:47:50.58125')
...
-- Insert lessons
INSERT INTO lessons (id, course_id, slug, title, content, "order", created_at)
VALUES
  (1, 1, 'what-is-project', 'プロジェクトとは', '# プロジェクトとは
...
プロジェクトマネジメントは、この独自性と有期性を持つプロジェクトを成功に導くための知識とスキルです。', 1, '2025-10-22 05:15:43.8724'),
  (2, 1, 'project-lifecycle', 'プロジェクトライフサイクル', '# プロジェクトライフサイクル
...
- **プロジェクトの種類によって異なる**: 建設プロジェクトとソフトウェア開発プロジェクトでは、ライフサイクルが異なります', 2, '2025-10-22 05:15:43.8724'),
  (3, 2, 'stakeholder-management', 'ステークホルダーマネジメント', '# ステークホルダーマネジメント
...
3. **ギャップを埋める戦略**を立案', 1, '2025-10-22 06:47:50.58125'),
  (4, 2, 'risk-management', 'リスクマネジメント', '# リスクマネジメント
...
-- Insert questions
INSERT INTO questions (id, lesson_id, type, question, options, correct_answer, explanation, "order", created_at)
VALUES
  (1, 1, 'multiple-choice', 'プロジェクトの定義として正しいものはどれか？',
  ...
  (2, 1, 'multiple-choice', '次のうち、プロジェクトに該当するものはどれか？',
  ...
  (12, 1, 'multiple-answer', 'プロジェクトの特徴として正しいものはどれか？（複数選択）',
  ...
  (3, 2, 'multiple-choice', 'プロジェクトライフサイクルの最初のフェーズはどれか？',
   ARRAY['立ち上げ','計画','実行','終結'],
   ARRAY['立ち上げ'],
   'プロジェクトライフサイクルは「立ち上げ→計画→実行→監視・コントロール→終結」の順に進みます。最初のフェーズは立ち上げです。',
   1, '2025-10-22 05:15:43.8724'),
  (4, 2, 'multiple-choice', 'プロジェクトの終結フェーズで行うべき活動はどれか？',
   ...
   2, '2025-10-22 05:15:43.8724'),
  (11, 2, 'multiple-answer', 'プロジェクトライフサイクルに含まれる主要なフェーズはどれか？（複数選択）',
   ...
   999, '2025-10-22 14:48:15.22086'),
  (5, 3, 'multiple-choice', '高パワー・高関心のステークホルダーに対する適切な対応はどれか？',
  ...
  (6, 3, 'multiple-choice', 'ステークホルダーマネジメントの主な目的はどれか？',
  ...
  (13, 3, 'multiple-answer', 'ステークホルダー分析で使用される評価軸はどれか？（複数選択）',
   ...
   999, '2025-10-22 14:48:15.22086'),
  (7, 4, 'multiple-choice', 'プロジェクトで使用予定の新技術が不確実なため、その技術を使わないことにした。これはどのリスク対応戦略か？',
   ARRAY['回避','転嫁','軽減','受容'],
   ARRAY['回避'],
   '回避戦略は、リスクの原因そのものを排除することです。不確実な技術を使わないという選択は、そのリスクを完全に回避しています。',
   1, '2025-10-22 06:47:50.58125'),
  (8, 4, 'multiple-choice', 'リスク分析において、発生確率と影響度を掛け合わせて算出するものはどれか？',
   ARRAY['コスト','優先度','スケジュール','品質'],
   ARRAY['優先度'],
   'リスクの優先度は、発生確率と影響度を掛け合わせて算出されます。これにより、どのリスクに優先的に対応すべきかを判断できます。',
   2, '2025-10-22 06:47:50.58125'),
  (14, 4, 'multiple-answer', 'ネガティブリスクに対する対応戦略として正しいものはどれか？（複数選択）',
